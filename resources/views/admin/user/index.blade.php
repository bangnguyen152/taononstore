                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-title">
                                ...
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <!--end::Svg Icon-->
                                    <label>
                                        <form method="get" action="{{ route('user')}}" class="form-inline mr-auto">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                    ...
                                    <!--end::Export-->
                                    <!--begin::Add user-->
                                    <button type="button" onclick="location.href='{{route('create')}}'"
                        ...
                        <div class="card-body py-4">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">Số Điện Thoại</th>
                                    <th class="min-w-125px">Địa chi</th>
                                    <th class="min-w-125px">Quyền</th>
