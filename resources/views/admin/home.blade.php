     ...
     <rect x="5" y="5" width="5" height="5" rx="1" fill="#000000"/>
        ...
        <rect x="14" y="14" width="5" height="5" rx="1" fill="#000000" opacity="0.3"/>
                                            ...
                                            <div
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3" data-bs-toggle="tooltip"
                            ...
                            Recurring
                                                ...
                                                <div class="menu-item px-3 my-1">
                                                    <a href="https://preview.keenthemes.com/metronic8/laravel/account/settings"
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="mixed-widget-2-chart card-rounded-bottom bg-danger"
                                             ...
                                             data-kt-chart-url="https://preview.keenthemes.com/metronic8/laravel/api/profits"
                                        ...
                                        <div class="card-p mt-n20 position-relative">
                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                                    ...
                                                    <span
                                                        class="svg-icon svg-icon-3x svg-icon-warning d-block my-2"><svg
...
<rect x="3" y="13" width="3" height="6" rx="1.5" fill="currentColor"/>
                                                ...
                                                <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                                    ...
                                                    <span
                                                        class="svg-icon svg-icon-3x svg-icon-primary d-block my-2"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none">
<path opacity="0.3"
    ...
    fill="currentColor"/>
                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col bg-light-danger px-6 py-8 rounded-2 me-7">
                                                    ...
                                                    <span
                                                        class="svg-icon svg-icon-3x svg-icon-danger d-block my-2"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none">
<path opacity="0.3"
...
<path
    ...
    fill="currentColor"/>
                                                ...
                                                <div class="col bg-light-success px-6 py-8 rounded-2">
                                                    ...
                                                    <span
                                                        class="svg-icon svg-icon-3x svg-icon-success d-block my-2"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none">
<path
     ...
     <rect x="5" y="5" width="5" height="5" rx="1" fill="#000000"/>
        ...
        <rect x="14" y="14" width="5" height="5" rx="1" fill="#000000" opacity="0.3"/>
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                                 data-kt-menu="true" id="kt_menu_6299b3704e101">
                                                <!--begin::Header-->
                                                <div class="px-7 py-5">
                                                    ...
                                                    <div class="mb-10">
                                                        ...
                                                        <div>
                                                            <select class="form-select form-select-solid"
                                                                    ...
                                                                    data-dropdown-parent="#kt_menu_6299b3704e101"
                                        ...
                                        <div class="timeline-label">
                                            ...
                                            <div class="timeline-item">
                                                ...
                                                <div class="timeline-content d-flex">
                                                            <span
                                                                class="fw-bolder text-gray-800 ps-3">AEOL meeting</span>
                                                </div>
                                                <!--end::Content-->
                                            </div>
                                            <!--end::Item-->
