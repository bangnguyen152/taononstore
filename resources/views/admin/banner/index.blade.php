                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-title">
                                ...
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <!--end::Svg Icon-->
                                    <label>
                                        <form method="get" action="{{ route('banner')}}" class="form-inline mr-auto">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                    ...
                                    <!--end::Export-->
                                    <!--begin::Add user-->
                                    <button type="button" onclick="location.href='{{route('banner.create')}}'"
                                            class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#kt_modal_add_user" enctype="multipart/form-data">
                        ...
                        <div class="card-body py-4">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">Start at</th>
                                    <th class="min-w-125px">End at</th>
                                ...
                                @foreach($banners as $banner)
                                    <tr>
                                        ...
                                        <td>
                                            @if($banner->status===1)
                                                <div class="badge badge-light-success fw-bolder">Hoạt động
                                                </div>
                                            @endif
                                            @if($banner->status===0)
                                                <div class="badge badge-light-danger fw-bolder">Đã Dừng
                                                </div>
                                            @endif
                                        </td>
                                        <!--end::Two step=-->
                                        ...
                                        <td class="text-end">
                                                <form action="{{route('banner.edit',$banner)}}" method="post">
                                                    @csrf
                                                    @method('put')
