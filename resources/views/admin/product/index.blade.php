                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-title">
                                ...
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <!--end::Svg Icon-->
                                    <form method="get" action="{{ route('product')}}" class="form-inline mr-auto">
                        ...
                        <div class="card-body py-4">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    <th>#</th>
                                    <th class="min-w-125px">Thuộc</th>
                                    <th class="min-w-125px">Tên</th>
                                    <th class="min-w-125px">Giá</th>
                                ...
                                @foreach($products as $product)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="ms-5">
                                                <a href="{{route('product_detail',$product)}}" class="text-gray-800 text-hover-primary fs-5 fw-bolder">
                                                    {{ $product->title }}
                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            @if($product->status===1)
                                                <div class="badge badge-light-success fw-bolder">Còn hàng
                                                </div>
                                            @endif
                                            @if($product->status===0)
                                                <div class="badge badge-light-danger fw-bolder">Hết hàng
                                                </div>
                                            @endif
                                        </td>
                                        <!--end::Two step=-->
